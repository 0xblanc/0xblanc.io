    ...
    <div id='past-projects' className='relative items-center bg-aliceBlue py-28 overflow-hidden'>
      <div className='w-full flex justify-center flex-col h-5/6'>
        ...
        <div className='flex lg:hidden justify-center mt-20 my-10'>
          <img className='hs-banner-mobile w-4/5' src='https://res.cloudinary.com/blanc-io/image/upload/q_auto/v1656758658/website/hs-banner_rbuv7x.webp' alt='HS Banner' width={770} height={344} />
        </div>
          ...
          <div className='flex flex-col italic text-xl lg:text-3xl text-center text-deepDarkBlue'>
            <div className='relative'>
              <div className='hs-banner-desktop absolute hidden lg:block w-[700px] top-[-375px] left-[-12px]'>
                <img src='https://res.cloudinary.com/blanc-io/image/upload/q_auto/v1656758658/website/hs-banner_rbuv7x.webp' width={770} height={344} alt='HS banner' />
              </div>
              <p>
            ...
            <div className='relative'>
              <div className='hs-clash absolute hidden lg:block w-[335px] top-[-306px] right-[-160px]'>
                <img src='https://res.cloudinary.com/blanc-io/image/upload/q_auto/v1656758660/website/hs-clash_g9a04i.webp' width={335} height={330} alt='HS clash' />
              </div>
              <p>
            ...
            <div className='relative'>
              <div className='hs-nft absolute hidden lg:block w-[300px] top-[-112px] left-[-340px]'>
                <img src='https://res.cloudinary.com/blanc-io/image/upload/q_auto/v1656758658/website/hs-nft_us4we2.webp' width={300} height={300} alt='HS nft' />
              </div>
              <p>
            ...
            <div className='relative'>
              <div className='hs-nyc absolute hidden lg:block w-[350px] top-[-12px] right-[-390px]'>
                <img src='https://res.cloudinary.com/blanc-io/image/upload/q_auto/v1656758660/website/hs-nyc_dpewwp.webp' width={350} height={350} alt='HS nyc' />
              </div>
              <p>
            ...
            <div className='relative'>
              <div className='hs-hunger-desktop absolute hidden lg:block w-[320px] bottom-[-375px] right-[54px]'>
                <img src='https://res.cloudinary.com/blanc-io/image/upload/q_auto/v1656758660/website/hs-hunger_xeyaxu.webp' width={320} height={320} alt='HS hunger' />
              </div>
              <div className='hs-wanted-desktop absolute hidden lg:block w-[340px] bottom-[-432px] left-[100px]'>
                <img src='https://res.cloudinary.com/blanc-io/image/upload/q_auto/v1656758660/website/hs-wanted_sctfre.webp' width={340} height={340} alt='HS wanted' />
              </div>
              <p>
        ...
        <div className='flex lg:hidden mt-10'>
          <div className='w-1/2 flex pt-10 pb-2 px-2'>
            <img className='hs-wanted-mobile' src='https://res.cloudinary.com/blanc-io/image/upload/q_auto/v1656758660/website/hs-wanted_sctfre.webp' alt='HS wanted' />
          </div>
          <div className='w-1/2 flex pt-2 pb-10 px-2'>
            <img className='hs-hunger-mobile' src='https://res.cloudinary.com/blanc-io/image/upload/q_auto/v1656758660/website/hs-hunger_xeyaxu.webp' alt='HS hunger' />
          </div>
        </div>
      </div>
    </div>
