  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:description" content={`Hong Kong based web3 and blockchain solution provider. Want to integrate web3 into your business? Need blockchain related technical services or consultation like launching NFT projects? Then 0xBlanc.io is the place to be.`} />
