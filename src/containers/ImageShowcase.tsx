const ImageShowcase = () => {
  return (
    <div className="h-screen sm:mx-0 xl:mx-64 flex flex-col justify-center">
      ...
      <div className="grid sm:grid-cols-2 w-full h-1/2 my-10  flex-col-reverse sm:flex-col">
        <div className="col-span-1 bg-aliceBlue h-full flex space-y-10 flex-col justify-end md:justify-start">
          <div>1</div>
          <div>1</div>
          <div>1</div>
          <div>1</div>
