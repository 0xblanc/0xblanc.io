  ...
  return (
    <div className='container mx-auto py-28 xl:px-10'>
      ...
      <div className='flex flex-col-reverse md:flex-row mx-auto pt-16'>
        <div className='flex md:flex-col flex-1 pt-8 lg:pt-24 xl:pl-16 sm:mr-10  justify-evenly  md:justify-start'>
        ...
        <div className='flex bg-aliceBlue mx-20 md:ml-10 md:mr-0 translate-x-10'>
          <div>
            ...
            <ReactCompareSlider
              ...
              itemOne={<ReactCompareSliderImage src={Moonbirds} alt='Moonbirds' />}
              itemTwo={<ReactCompareSliderImage src={AINightbirds} alt='AINightbirds' />}
            />
          </div>
        </div>
      </div>
